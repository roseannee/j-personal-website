    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 bg-transparent p-0 text-muted-foreground"
        ),
        ...
        Dropdown: ({ ...props }) => (
          ...
          >
            <SelectTrigger
              className={cn(
                buttonVariants({ variant: "ghost" }),
                "h-7 w-fit cursor-pointer py-2 pl-2 pr-1 font-medium [.is-between_&]:hidden [.is-end_&]:hidden [.is-start.is-end_&]:flex"
              )}
            >
